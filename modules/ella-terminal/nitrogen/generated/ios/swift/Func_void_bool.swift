...
/**
 * Wraps a Swift `(_ active: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_bool {
  public typealias bridge = margelo.nitro.ella.terminal.bridge.swift

  private let closure: (_ active: Bool) -> Void

  public init(_ closure: @escaping (_ active: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(active: Bool) -> Void {
    self.closure(active)
  }
